...
const ServiceUpdate = ({ route, navigation }) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button style={{margin: 20}} buttonColor="orange" textColor="black" mode="contained" onPress={handleUploadImage}>
                Đổi ảnh
            </Button>
            ...
            />
            <Button style={{margin: 20}} buttonColor="orange" textColor="black" mode="contained" onPress={handleUpdateService}>
                Cập nhật
            </Button>
        </View>
    );
