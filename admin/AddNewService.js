...
const AddNewService = ({navigation}) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button textColor="black" buttonColor="orange" style={{margin: 10}} mode="contained" onPress={handleUploadImage}>
                Upload Ảnh
            </Button>
            {((imagePath!= "")&&
            ...
            <TextInput
                ...
                style={{ marginBottom: 10, borderWidth: 1, borderColor: '#ccc' }}
            />
            <Button buttonColor="orange" textColor="black" mode="contained" onPress={handleAddNewService}>Thêm sản phẩm</Button>
        </View>
    );
};
